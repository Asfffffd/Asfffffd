...
public:
    ...
    , pcKrSwCurve_("Matrix.SpatialParams")
    {
        ...
        permeabilityWell_ = getParamFromGroup<Scalar>(paramGroup, "SpatialParams.PermeabilityWell_");
        permeabilityRock_ = getParamFromGroup<Scalar>(paramGroup, "SpatialParams.PermeabilityRock_");
    }

    //! Function for defining the (intrinsic) permeability \f$[m^2]\f$.
    PermeabilityType permeabilityAtPos(const GlobalPosition& globalPos) const
    {
    	if (globalPos[1] < 0.15 + 1e-6)
